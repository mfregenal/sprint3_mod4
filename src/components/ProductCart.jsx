  ...
  return (
    <div className="grid grid-cols-3 items-center lg:w-xl w-64 rounded-xl bg-sky-800 p-2">
      ...
      <div className="flex justify-center items-center rounded-xl p-1 gap-2">
        {/* BOTÓN MENOS */}
        <button className="hover:text-emerald-500" onClick={ () => {decrement(), updateProductCantidad(product.id, counter - 1)} }>
        ...
        {/* BOTÓN MAS */}
        <button className="hover:text-emerald-500" onClick={ () => {increment(), updateProductCantidad(product.id, counter + 1)} }>
